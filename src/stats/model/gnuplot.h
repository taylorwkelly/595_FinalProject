...
class Gnuplot2dDataset : public GnuplotDataset
{
  public:
    ...
    /**
     * \param style the style of plotting to use for this dataset with a string.
     */
     ...
     * \param x x coord to new data point
     * \param y y coord to new data point
     * \param label label to show at point
     *
     * Use this method to add a new 2D point with a label
     */
    void Add(double x, double y, std::string label);
  ...
  private:
    ...
    struct Point
    {
        ...
        std::string label; //!< the label for the point
    };
    ...
    static std::string m_defaultStringStyle;  //!< default plot style
...
class Gnuplot3dDataset : public GnuplotDataset
{
  public:
     ...
     * \param label label to show at point
     *
     * Use this method to add a new 3D point with a label
     */
    void Add(double x, double y, double z, std::string label);
